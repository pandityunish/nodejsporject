...
module.exports.deleteaccount = async (req, res) => {
  try {
    ...
    let deleteaccount = DeleteUser({
      aboutme, age, puid, diet, lat, lng,status, disability, drink, imageurls, placeofbirth, timeofbirth, education, height, income, patnerprefs, smoke, displayname, email, religion, name, surname, phone, gender, kundalidosh, martialstatus, profession, location1, city, state, country, token, dob, reasontodeleteuser
    })
