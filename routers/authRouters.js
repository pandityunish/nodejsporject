...
authRouter.post("/auth/updateeditstatusapprove",updateeditstatusapprove);
authRouter.post("/auth/updatenumofinterest",updatenumofinterest);
authRouter.post("/auth/updatenumofprofileviewer",updatenumofprofileviewer);
...
authRouter.post("/auth/updateunapproveactivites",updatedunapproveactivites);
authRouter.post("/auth/addtounseenmessage",addtounseenmessages);
authRouter.post("/auth/updateunseenmessage",updatedunseenmessage);
authRouter.post("/auth/updateoffiletime",updateoffiletime);
